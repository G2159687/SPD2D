...
public class DungeonTilemap extends Tilemap {
	...
	static {
		...
		chasmStitcheable.put( Terrain.EMBERS, 32 );
		chasmStitcheable.put( Terrain.SIGN, 32 );
		chasmStitcheable.put( Terrain.EMPTY_WELL, 32 );
		chasmStitcheable.put( Terrain.STATUE, 32 );
        chasmStitcheable.put( Terrain.SECRET_TRAP,  32 );
        chasmStitcheable.put( Terrain.TRAP,32 );
        chasmStitcheable.put( Terrain.BOOKSHELF, 32 );
        chasmStitcheable.put( Terrain.BARRICADE, 32 );
        chasmStitcheable.put( Terrain.INACTIVE_TRAP,32 );
        chasmStitcheable.put( Terrain.PEDESTAL,     32 );
