...
import com.shatteredpixel.spd2d.actors.buffs.SoulMark;
import com.shatteredpixel.spd2d.actors.buffs.Terror;
import com.shatteredpixel.spd2d.actors.hero.Hero;
import com.shatteredpixel.spd2d.actors.hero.HeroSubClass;
import com.shatteredpixel.spd2d.effects.Flare;
import com.shatteredpixel.spd2d.effects.Speck;
import com.shatteredpixel.spd2d.effects.Surprise;
import com.shatteredpixel.spd2d.effects.Wound;
...
import com.shatteredpixel.spd2d.levels.Level.Feeling;
...
public abstract class Mob extends Char {
	...
	protected boolean getCloser( int target ) {
		...
		if (Dungeon.level.adjacent( pos, target )) {
			...
			if (path == null || path.isEmpty() || !Dungeon.level.adjacent(pos, path.getFirst())|| path.size() > 2*Dungeon.level.distance(pos, target))
				newPath = true;
