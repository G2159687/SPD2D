 ...
 */
package com.shatteredpixel.spd2d.messages;
...
public class Messages {
	...
	private static String[] prop_files = new String[]{
			"com.shatteredpixel.spd2d.messages.actors.actors",
			"com.shatteredpixel.spd2d.messages.items.items",
			"com.shatteredpixel.spd2d.messages.journal.journal",
			"com.shatteredpixel.spd2d.messages.levels.levels",
			"com.shatteredpixel.spd2d.messages.plants.plants",
			"com.shatteredpixel.spd2d.messages.scenes.scenes",
			"com.shatteredpixel.spd2d.messages.ui.ui",
			"com.shatteredpixel.spd2d.messages.windows.windows",
			"com.shatteredpixel.spd2d.messages.misc.misc"
	};
	...
	public static String get(Class c, String k, Object...args){
		String key;
		if (c != null){
			key = c.getName().replace("com.shatteredpixel.spd2d.", "");
			key += "." + k;
		} else
			key = k;
